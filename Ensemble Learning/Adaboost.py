...
#importing randomforestclassifier, AdaboostClassifier from ensemble class
import numpy as np
...
ra = RandomForestClassifier() #initilized the RandomForest clasifier
bg = AdaBoostClassifier(base_estimator=ra, n_estimators=100) #initilized the Adaboost clasifier
